...
\lstinline@muxU31@ (for the chip listed as U31 on the schematic), you can read 
the input values using \lstinline@uint16_t muxVal = muxU31.read()@. This returns a 16-bit 
...
%\subsection{Measuring Temperature and Humidity}
%Explain SHT31
...
in the usual manner. It requires the usual:
\begin{enumerate}

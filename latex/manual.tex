...
\author{Seth McNeill}
\date{Edition Spring 2024 (v0.6) \\ \myDate\today}
...
\begin{document}
  ...
  \setcounter{chapter}{-1}
    ...
    \include{MuxLED/MuxLED.tex}
    \include{ButtonsSerial/ButtonsSerial.tex}
    \include{displays/displays.tex}
    \include{envSensing/envSensing.tex}
    %\include{moreSensors/moreSensors.tex}
    \include{imu/imu.tex}
    \include{distMotorServo/distMotorServo.tex}
    \include{peakDetection/peakDetection.tex}
    \include{machineLearning/machineLearning.tex}
    \include{controls/controls.tex}
    \include{wireless/wireless.tex}
